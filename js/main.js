...
(function () {
  ...
  function renderOffers() {
    ...
    // The Offers section always stays visible — when there is no active
    // offer it shows an elegant "no offer" placeholder card instead of
    // being hidden, and swaps back to real offers automatically as soon
    // as the admin activates one (renderOffers re-runs on every Firebase
    // offers update).
