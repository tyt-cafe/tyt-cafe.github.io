...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      "comments.lede": "Leave a comment about TYT — your visit, your favorite drink, anything at all.",
    ...
    ar: {
      ...
      "comments.lede": "اترك تعليق عن TYT — زيارتك، مشروبك المفضل، أو أي حاجة تحب تقولها.",
  ...
  var MENU_AR = {
    ...
    items: {
      ...
      "fresh-juices::banana with milk": { name: "موز باللبن" },
      "fresh-juices::dates with milk": { name: "تمر باللبن" },
      "fresh-juices::power cocktail": { name: "باور كوكتيل" },
      "fresh-juices::avocado": { name: "أفوكادو" },
      "fresh-juices::avocado honey": { name: "أفوكادو بالعسل" },
